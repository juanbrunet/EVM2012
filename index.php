...
query_posts("cat=3,5,4,7,8&showposts=5&paged=$page");
		 ?>
		<?php rewind_posts() ?>
		<?php if(have_posts()): ?>
 ...
 <div class="post_info">
                ...
                <li><img src="<?php echo  get_template_directory_uri() . "/images/author.png" ?>" class="meta-img" alt="" /> Autor:  <?php the_author(); ?> </li>
					...
					<div class="post-content">
				    	...
				    	<a href="<?php the_permalink() ?>" class="read-more">(Continuar leyendo...)</a><span><?php if(!is_page()) { ?><a href="<?php comments_link(); ?>"><?php comments_number('0', '1', '%'); ?> Comentarios</a> <?php } ?></span>
                 
					    <div class="clear"></div>
					</div>
					<?php if(($setting == 'auto' && !has_excerpt()) || ($setting != 'excerpt')): ?>
			...
			<div class="post-pages">
			    <div class="pages-prev"><?php next_posts_link(__("&laquo; Entradas antiguas"))?></div>
			    <div class="pages-next"><?php previous_posts_link(__("Entradas recientes &raquo;"))?></div>
			    <div class="clear"></div>
			</div>
		<?php else: ?>
			<p>Lo sentimos, no se encuentra contenido bajo ese criterio.</p>
		<?php endif; ?>
		</div>
		<?php get_sidebar(); ?>
	<div class="clear"></div>
