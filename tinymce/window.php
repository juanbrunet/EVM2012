...
require_once( dirname( dirname(__FILE__) ) .'/cetsHelloWorld-config.php');
...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
	...
	<div class="tabs">
		<ul>
			<li id="rss_tab" class="current"><span><a href="javascript:mcTabs.displayTab('rss_tab','rss_panel');" onmousedown="return false;"><?php _e("rss", 'cetsHW'); ?></a></span></li>
		</ul>
	</div>
	...
	<div class="panel_wrapper">
		...
		<table border="0" cellpadding="4" cellspacing="0">
         <tr>
            <td nowrap="nowrap"><label for="rsstag"><?php _e("Enter your name:", 'cetsHW'); ?></label></td>
